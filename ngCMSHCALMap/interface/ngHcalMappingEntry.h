...
class HBHEHFLogicalMapEntry 
{
 ...
 public:
  ...
  int myuhtr_crate_, myuhtr_, myuhtr_dcc_, myuhtr_spigot_, myuhtr_htr_fi_, myuhtr_fedid_, myuhtr_trgf_, myuhtr_trgfc_;
  ...
  int mycrate_, myhtr_, my_htr_fi_, mydcc_, myspigot_;
  std::string mytb_;
...
class HOHXLogicalMapEntry 
{
 ...
 public:
  ...
  std::string mydet_;
  int mysid_, myet_, myph_, mydep_;
  int mycrate_, myhtr_, my_htr_fi_, myfi_ch_, mydcc_, myspigot_;
  std::string mytb_;
};
...
class CALIBLogicalMapEntry 
{
 ...
 public:
  ...
  int mysid_, myet_, myph_, mychty_;
  int mycrate_, myhtr_, my_htr_fi_, myfi_ch_, mydcc_, myspigot_;
  std::string mytb_;
...
class HTLogicalMapEntry 
{
 ...
 public:
  ...
  //input data members
  int myside_, mydphi_, myeta_, myphi_, mydepth_, mywedge_;
  ...
  int myuhtr_crate_, myuhtr_, myuhtr_dcc_, myuhtr_spigot_, myuhtr_htr_fi_, myuhtr_fedid_, myuhtr_trgf_, myuhtr_trgfc_;
  std::string myuhtr_fpga_;
  std::string mydet_origin_;

  int mycrate_, myhtr_, myslb_, myslbch_, mydcc_, myspigot_;
  std::string mytb_;
